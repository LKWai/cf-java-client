...
public class IntegrationTestConfiguration {
    ...
    Mono<String> serviceBrokerId(CloudFoundryClient cloudFoundryClient, NameFactory nameFactory, Mono<String> spaceId, String serviceBrokerName, String serviceName, String planName)
        ...
        return Mono
            ...
            .flatMap(function((space, domain) -> Mono
                .when(
                ...
                .flatMap(function((applicationId, routeId) -> cloudFoundryClient.applicationsV2()
                    .associateRoute(AssociateApplicationRouteRequest.builder()
                        .applicationId(applicationId)
                        .routeId(routeId)
                        .build())
                    .then(Mono.just(applicationId))))
                .delayUntil(applicationId -> cloudFoundryClient.applicationsV2()
            ...
            .flatMap(url -> cloudFoundryClient.serviceBrokers()
                .create(CreateServiceBrokerRequest.builder()
                    ...
                    .build())
                .map(ResourceUtils::getId))
            .delayUntil(serviceBrokerId -> PaginationUtils
                ...
                .flatMapMany(serviceId -> PaginationUtils
                    ...
                    .single()
                    .map(ResourceUtils::getId))
                .flatMap(planId -> cloudFoundryClient.servicePlans()
